...
$opt = "<select class='supplier-opt' name='product-supplier'>
...
<div id="add-form">
  <form action="product_add.php" method="POST">
    ...
    <input type="number" min="1" max="9999999" name="product-quantity" placeholder="0" required>

    <label for="product-price">Product Price:</label>
    <input type="number" min="1" max="9999999" name="product-price" placeholder="0" required>
