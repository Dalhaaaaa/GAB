...
<div id="add-form">
  <form action="store_add.php" method="POST">
    ...
    <input type="text" name="store-address" placeholder="Store Address" required>

    <label for="store-price">Store Phone:</label>
    <input type="text" name="store-phone" placeholder="Store Phone Number" required>

    <label for="store-email">Store Email:</label>
    <input type="text" name="store-email" placeholder="Store Email" required>
