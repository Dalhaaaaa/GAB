...
if (isset($_SESSION['id']) && isset($_SESSION['username']) && $_SESSION['role'] === 'store_owner' || 'admin') {
    if ($_SERVER["REQUEST_METHOD"] === "POST" && !empty($_POST['store-owner-opt']) && !empty($_POST['method-opt'])) {
        // Include the database connection file
        include "../includes/db_connection.php";

        // Retrieve the order data from the request
        $storeId = $_POST['store-owner-opt'];
